...
namespace Latihan_PointOfSales.Class
{
    class clsSupplier
    {
        private static string tabel = "supplier";
        ...
        public clsSupplier(int id)
        {
            this.id = id;
        }

        public clsSupplier(string nama, string alamat, string zip_code, string phone_number, string email)
        {
            this.nama = nama;
            this.alamat = alamat;
        ...
        public clsSupplier(int id, string nama, string alamat, string zip_code, string phone_number, string email)
        {
            this.id = id;
            this.nama = nama;
            this.alamat = alamat;
        ...
        public static Dictionary<string, string> cariSupplier(string id)
        {
        ...
        public int UpdateSupplier(int id, string nama, string alamat, string zip_code, string phone_number, string email)
        {
            int res;
            clsDatabase.buka_koneksi();
